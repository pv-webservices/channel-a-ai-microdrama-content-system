...
`npm run validate` checks manifest structure, strict TypeScript, and Remotion composition discovery. GitHub Actions runs the same gate for pull requests and `main`.
