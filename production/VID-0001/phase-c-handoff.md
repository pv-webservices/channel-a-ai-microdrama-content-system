...
## Locked pre-production package

- approved concept
- approved hook
- approved script
- retention review
- CHAR-001 / CHAR-002 identity locks
- PROP-001 / PROP-002 / PROP-003 continuity locks
- 7-scene storyboard
...
Visual generation must not silently alter:
- character identity
- wardrobe
- room geography
- prop identity
